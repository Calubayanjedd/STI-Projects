...
namespace St._Rome
{
    public partial class PatientRegistration : Form
    {
        ...
        public PatientRegistration(PatientInfo frm11)
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand md = new SqlCommand("select * from AdminLogin where adminID = '" + id + "'"))
                {
                    ...
                    {
                        cmd.CommandText = @"INSERT INTO[dbo].[PatientInfo]
                          ([adminID], [firstname]
                         ,[lastname]
                         ,[middlename]
                         ,[address]
                ...
                MessageBox.Show("Patient Registered Successfully.", "Successfully", MessageBoxButtons.OK);
                addPatient();
                this.Hide();
            }
            catch
        ...
        private void suffixcbx_SelectedIndexChanged(object sender, EventArgs e)
        {
